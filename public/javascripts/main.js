	  var moneyOn = 0;
		...
		$.get('/getSquads',function(data){
				squads = (data);
				console.log("in squads run" + squads);
		});
        listRounds(17);
		...
		function dlPlayers(){
			...
			users = [];
			players = [];
			//httpGetAsync('https://fgp-data.s3-ap-southeast-2.amazonaws.com/json/fox_super_rugby/players.json?_=1490695855653',getPlayers);
			readTextFile("players.json",getPlayers);
		}
		...
		function addAllUsers(){
			//httpGetAsync('https://backend-fox.fanhubmedia.com.au/super_rugby_classic/api/classic_team/show?id=1758&round=11&sid=c1020c64ed3cccfacafc75e5c637abe7aaec5f79&_=1494146579978',addUser);
			//httpGetAsync('https://backend-fox.fanhubmedia.com.au/super_rugby_classic/api/classic_team/show?id=5651&round=11&sid=c1020c64ed3cccfacafc75e5c637abe7aaec5f79&_=1494146579985',addUser);
			//httpGetAsync('https://backend-fox.fanhubmedia.com.au/super_rugby_classic/api/classic_team/show?id=5076&round=11&sid=c1020c64ed3cccfacafc75e5c637abe7aaec5f79&_=1494146633565',addUser);
			//httpGetAsync('https://backend-fox.fanhubmedia.com.au/super_rugby_classic/api/classic_team/show?id=4354&round=11&sid=c1020c64ed3cccfacafc75e5c637abe7aaec5f79&_=1494146633568',addUser);
			//httpGetAsync('https://backend-fox.fanhubmedia.com.au/super_rugby_classic/api/classic_team/show?id=4632&round=11&sid=c1020c64ed3cccfacafc75e5c637abe7aaec5f79&_=1494146679428',addUser);
			//httpGetAsync('https://backend-fox.fanhubmedia.com.au/super_rugby_classic/api/classic_team/show?id=4350&round=11&sid=c1020c64ed3cccfacafc75e5c637abe7aaec5f79&_=1494146679431',addUser);
			//httpGetAsync('https://backend-fox.fanhubmedia.com.au/super_rugby_classic/api/classic_team/show?id=4371&round=11&sid=c1020c64ed3cccfacafc75e5c637abe7aaec5f79&_=1494146714478',addUser);
			//httpGetAsync('https://backend-fox.fanhubmedia.com.au/super_rugby_classic/api/classic_team/show?id=4317&round=11&sid=c1020c64ed3cccfacafc75e5c637abe7aaec5f79&_=1494146714481',addUser);
			readTextFile("user1.json",addUser);
			readTextFile("user2.json",addUser);
			readTextFile("user3.json",addUser);
      readTextFile("user4.json",addUser);
			readTextFile("user5.json",addUser);
      readTextFile("user6.json",addUser);
			readTextFile("user7.json",addUser);
      readTextFile("user8.json",addUser);
		}
		var loadedOnce =0;
		function setZoom(){
			if(screen.width<992){
				...
				if((players[i].status == 'playing')){
					...
					if(players[i].squad_id == team1Id){
						...
						for(var j=0;j<users.length;j++){
							for(var k=0;k<users[j].result.lineup[players[i].positions[0]].length;k++){
								if(players[i].id==users[j].result.lineup[players[i].positions[0]][k]){
									if(users[j].result.lineup.captain==players[i].id){
										ownerList1 = ownerList1 + users[j].result.last_name.substring(0,nameLength)+"(C)<br>";
									}else{
										ownerList1 = ownerList1 + users[j].result.last_name.substring(0,nameLength)+"<br>";
              ...
              value:players[i].stats.prices[round],
						...
						for(var j=0;j<users.length;j++){
							for(var k=0;k<users[j].result.lineup[players[i].positions[0]].length;k++){
								if(players[i].id==users[j].result.lineup[players[i].positions[0]][k]){
									if(users[j].result.lineup.captain==players[i].id){
										ownerList2 = ownerList2 + users[j].result.last_name.substring(0,nameLength)+"(C)<br>";
									}else{
										ownerList2 = ownerList2 + users[j].result.last_name.substring(0,nameLength)+"<br>";
									}
    ...
    function showMoney(fromLoad){
      ...
      var matchOn = 0;
		...
		function addUser(responseText){
			
			users.push(JSON.parse(responseText));
			if (users.length==8){
				console.log(users);
				console.log(gRound,fHomeId,firstHome,fAwayId,firstAway);
				if(currAway==""){
		...
		function getRounds(responseText){
			rounds = JSON.parse(responseText);
			if(roundFirstLoad==0){
				roundsThisWeek();
				roundFirstLoad += 1;
			}
		...
		function getSquads(responseText){
			squads = JSON.parse(responseText);
			dlRounds();
		}
		function getPlayers(responseText){
