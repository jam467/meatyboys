...
var getcurrSeason = require('./routes/getcurrSeason');
var getPlayers = require('./routes/getPlayers');
var getScoreboard = require('./routes/getScoreboard');
var getDraft = require('./routes/getDraft');
var getRound = require('./routes/getRound');
var Draft = require('./routes/Draft');
var getRemaining = require('./routes/draftDay/getRemaining');
...
app.use('/', index);
app.use('/getcurrSeason', getcurrSeason);
app.use('/getPlayers', getPlayers);
app.use('/getScoreboard', getScoreboard);
app.use('/startTimer', startTimer);
app.use('/getRemaining', getRemaining);
app.use('/Draft', Draft);
app.use('/getDraft', getDraft);
app.use('/getRound', getRound);
